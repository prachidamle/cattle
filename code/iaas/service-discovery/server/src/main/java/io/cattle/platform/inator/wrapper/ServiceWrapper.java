...
public class ServiceWrapper {
    ...
    public Map<String, GenericObject> getPullTasks() {
        ...
        Map<String, Object> ids = DataAccessor.fieldMapRO(service, ServiceConstants.FIELD_PULL_TASKS);
    ...
    public void savePullTasks(Map<String, GenericObject> newPullTasks) {
        ...
        svc.objectManager.setFields(service,
                ServiceConstants.FIELD_PULL_TASKS, ids);
    }
